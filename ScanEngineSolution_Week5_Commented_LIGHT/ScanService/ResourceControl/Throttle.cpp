...
// ROLE   : Thread rieng lay CPU/RAM/process I/O va cap nhat throttle state.
...
// Khoi dong monitor thread doc CPU/RAM/disk dinh ky de quyet dinh Normal hay Overloaded.
...
// Dung monitor thread an toan va join truoc khi module bi huy.
...
// Tra ve snapshot tai nguyen gan nhat cho WorkerLoop ma khong phai tu do lai.
...
// Lay cac performance counter va cap nhat MachineState.
// WorkerLoop dung state nay de delay job Low/Normal, nhung van cho High priority chay.
